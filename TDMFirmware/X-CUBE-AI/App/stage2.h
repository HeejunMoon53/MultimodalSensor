...
/******************************************************************************/
#define AI_STAGE2_MODEL_NAME          "stage2"
#define AI_STAGE2_ORIGIN_MODEL_NAME   "stage2_md"

/******************************************************************************/
#define AI_STAGE2_ACTIVATIONS_ALIGNMENT   (4)
#define AI_STAGE2_INPUTS_IN_ACTIVATIONS   (4)
#define AI_STAGE2_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_STAGE2_IN_NUM        (1)

AI_DEPRECATED
#define AI_STAGE2_IN \
  ai_stage2_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_STAGE2_IN_SIZE { \
  AI_STAGE2_IN_1_SIZE, \
}
#define AI_STAGE2_IN_SIZE_BYTES { \
  AI_STAGE2_IN_1_SIZE_BYTES, \
}
#define AI_STAGE2_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_STAGE2_IN_1_CHANNEL     (2)
#define AI_STAGE2_IN_1_SIZE        (2)
#define AI_STAGE2_IN_1_SIZE_BYTES  (8)

/******************************************************************************/
#define AI_STAGE2_OUT_NUM       (1)

AI_DEPRECATED
#define AI_STAGE2_OUT \
  ai_stage2_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_STAGE2_OUT_SIZE { \
  AI_STAGE2_OUT_1_SIZE, \
}
#define AI_STAGE2_OUT_SIZE_BYTES { \
  AI_STAGE2_OUT_1_SIZE_BYTES, \
}
#define AI_STAGE2_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_STAGE2_OUT_1_CHANNEL     (1)
#define AI_STAGE2_OUT_1_SIZE        (1)
#define AI_STAGE2_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_STAGE2_N_NODES (7)
 ...
 * @ref ai_stage2_create. Both the activations memory buffer 
 ...
 */
AI_API_ENTRY
ai_buffer* ai_stage2_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_stage2_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_STAGE2_*
 * defines into file @ref stage2.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
