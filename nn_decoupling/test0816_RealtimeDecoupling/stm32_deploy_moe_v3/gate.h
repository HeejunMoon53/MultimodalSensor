...
/******************************************************************************/
#define AI_GATE_MODEL_NAME          "gate"
#define AI_GATE_ORIGIN_MODEL_NAME   "gate"

/******************************************************************************/
#define AI_GATE_ACTIVATIONS_ALIGNMENT   (4)
#define AI_GATE_INPUTS_IN_ACTIVATIONS   (4)
#define AI_GATE_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_GATE_IN_NUM        (1)

AI_DEPRECATED
#define AI_GATE_IN \
  ai_gate_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_GATE_IN_SIZE { \
  AI_GATE_IN_1_SIZE, \
}
#define AI_GATE_IN_SIZE_BYTES { \
  AI_GATE_IN_1_SIZE_BYTES, \
}
#define AI_GATE_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_GATE_IN_1_CHANNEL     (2)
#define AI_GATE_IN_1_SIZE        (2)
#define AI_GATE_IN_1_SIZE_BYTES  (8)

/******************************************************************************/
#define AI_GATE_OUT_NUM       (2)

AI_DEPRECATED
#define AI_GATE_OUT \
  ai_gate_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_GATE_OUT_SIZE { \
  AI_GATE_OUT_1_SIZE, \
  AI_GATE_OUT_2_SIZE, \
}
#define AI_GATE_OUT_SIZE_BYTES { \
  AI_GATE_OUT_1_SIZE_BYTES, \
  AI_GATE_OUT_2_SIZE_BYTES, \
}
#define AI_GATE_OUT_1_FORMAT      (AI_BUFFER_FORMAT_S32)
#define AI_GATE_OUT_1_SIZE        (1)
#define AI_GATE_OUT_1_SIZE_BYTES  (4)
#define AI_GATE_OUT_2_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_GATE_OUT_2_CHANNEL     (2)
#define AI_GATE_OUT_2_SIZE        (2)
#define AI_GATE_OUT_2_SIZE_BYTES  (8)

/******************************************************************************/
#define AI_GATE_N_NODES (12)
 ...
 * @ref ai_gate_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_GATE_*
 * defines into file @ref gate.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
