...
/******************************************************************************/
#define AI_STAGE1_MODEL_NAME          "stage1"
#define AI_STAGE1_ORIGIN_MODEL_NAME   "stage1_md"

/******************************************************************************/
#define AI_STAGE1_ACTIVATIONS_ALIGNMENT   (4)
#define AI_STAGE1_INPUTS_IN_ACTIVATIONS   (4)
#define AI_STAGE1_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_STAGE1_IN_NUM        (1)

AI_DEPRECATED
#define AI_STAGE1_IN \
  ai_stage1_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_STAGE1_IN_SIZE { \
  AI_STAGE1_IN_1_SIZE, \
}
#define AI_STAGE1_IN_SIZE_BYTES { \
  AI_STAGE1_IN_1_SIZE_BYTES, \
}
#define AI_STAGE1_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_STAGE1_IN_1_CHANNEL     (1)
#define AI_STAGE1_IN_1_SIZE        (1)
#define AI_STAGE1_IN_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_STAGE1_OUT_NUM       (1)

AI_DEPRECATED
#define AI_STAGE1_OUT \
  ai_stage1_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_STAGE1_OUT_SIZE { \
  AI_STAGE1_OUT_1_SIZE, \
}
#define AI_STAGE1_OUT_SIZE_BYTES { \
  AI_STAGE1_OUT_1_SIZE_BYTES, \
}
#define AI_STAGE1_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_STAGE1_OUT_1_CHANNEL     (1)
#define AI_STAGE1_OUT_1_SIZE        (1)
#define AI_STAGE1_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_STAGE1_N_NODES (7)
 ...
 * @ref ai_stage1_create. Both the activations memory buffer 
 ...
 */
AI_API_ENTRY
ai_buffer* ai_stage1_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_stage1_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_STAGE1_*
 * defines into file @ref stage1.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
