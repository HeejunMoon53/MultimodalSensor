/**
  ...
  ******************************************************************************
  */
#ifndef AI_EXPERT_A_H
#define AI_EXPERT_A_H

#include "expert_a_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_EXPERT_A_MODEL_NAME          "expert_a"
#define AI_EXPERT_A_ORIGIN_MODEL_NAME   "expert_a"

/******************************************************************************/
#define AI_EXPERT_A_ACTIVATIONS_ALIGNMENT   (4)
#define AI_EXPERT_A_INPUTS_IN_ACTIVATIONS   (4)
#define AI_EXPERT_A_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_EXPERT_A_IN_NUM        (1)

AI_DEPRECATED
#define AI_EXPERT_A_IN \
  ai_expert_a_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_EXPERT_A_IN_SIZE { \
  AI_EXPERT_A_IN_1_SIZE, \
}
#define AI_EXPERT_A_IN_SIZE_BYTES { \
  AI_EXPERT_A_IN_1_SIZE_BYTES, \
}
#define AI_EXPERT_A_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_EXPERT_A_IN_1_CHANNEL     (4)
#define AI_EXPERT_A_IN_1_SIZE        (4)
#define AI_EXPERT_A_IN_1_SIZE_BYTES  (16)

/******************************************************************************/
#define AI_EXPERT_A_OUT_NUM       (1)

AI_DEPRECATED
#define AI_EXPERT_A_OUT \
  ai_expert_a_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_EXPERT_A_OUT_SIZE { \
  AI_EXPERT_A_OUT_1_SIZE, \
}
#define AI_EXPERT_A_OUT_SIZE_BYTES { \
  AI_EXPERT_A_OUT_1_SIZE_BYTES, \
}
#define AI_EXPERT_A_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_EXPERT_A_OUT_1_CHANNEL     (2)
#define AI_EXPERT_A_OUT_1_SIZE        (2)
#define AI_EXPERT_A_OUT_1_SIZE_BYTES  (8)

/******************************************************************************/
#define AI_EXPERT_A_N_NODES (7)
 ...
 * @ref ai_expert_a_create. Both the activations memory buffer 
 ...
 * using @ref ai_expert_a_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_expert_a_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_expert_a_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_EXPERT_A_*
 * defines into file @ref expert_a.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
